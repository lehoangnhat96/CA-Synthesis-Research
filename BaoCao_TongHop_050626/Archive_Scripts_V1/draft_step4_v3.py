...
draft = f"""# CHI TIẾT BẢN NHÁP CHƯƠNG 3 (BƯỚC 4 - Đã chỉnh sửa)

> Đã lược bỏ hoàn toàn phần Paracetamol theo yêu cầu để tập trung vào Kim loại nặng.
> Ký hiệu đã được format chuẩn Unicode điện tích: Fe²⁺/Fe³⁺.
> **Lưu ý Cấu trúc:** Để không làm mất các phần "Lý thuyết" (3.1) và "Sơ đồ xương cá" (3.4) rất hay đã có sẵn trong DCLV gốc, tôi sẽ chèn các kết quả dự kiến này thành các mục 3.2, 3.3, 3.4 mới và đẩy Sơ đồ xương cá xuống mục 3.5.
...
with open(draft_path, 'w', encoding='utf-8') as f:
    f.write(draft)
print("Draft for Chapter 3 V3 generated.")
