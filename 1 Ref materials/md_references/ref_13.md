# Reference [13] - Converted from PDF
Source: D:\1 Master's Ana Chem\1 Master's thesis\Carbon Aerogel\1 Ref materials\Identification of Highly Active Fe Sites in (Ni,Fe)OOH for Electrocatalytic Water Splitting.pdf
Full text extraction

## --- Page 1 ---

Identiﬁcation of Highly Active Fe Sites in (Ni,Fe)OOH for
Electrocatalytic Water Splitting
Daniel Friebel,*,†,§,¶ Mary W. Louie,†,‡,¶ Michal Bajdich,§,¶ Kai E. Sanwald,§,∥Yun Cai,†,‡ Anna M. Wise,⊥
Mu-Jeng Cheng,†,‡ Dimosthenis Sokaras,⊥Tsu-Chien Weng,⊥Roberto Alonso-Mori,# Ryan C. Davis,⊥
John R. Bargar,⊥Jens K. Nørskov,§ Anders Nilsson,†,§,⊥and Alexis T. Bell*,†,‡
†Joint Center for Artiﬁcial Photosynthesis, Lawrence Berkeley National Laboratory, 1 Cyclotron Road, Mail Stop 976, Berkeley,
...
∥Department of Chemistry, Technische Universität München, Lichtenbergstraße 4, 85749 Garching, Germany
...
ABSTRACT: Highly active catalysts for the oxygen evolution
reaction (OER) are required for the development of
photoelectrochemical devices that generate hydrogen eﬃ-
...
using high energy resolution ﬂuorescence detection (HERFD)
...
important and scientiﬁcally challenging issue. A critical
requirement for achieving this goal is an eﬃcient means for
...
shown that one of the most signiﬁcant performance losses of
...
in the catalyst will reduce the photon ﬂux to the photo-
...
intermediates involved in the OER.26,28 In an eﬀort to identify
...
J. Am. Chem. Soc. 2015.137:1305-1313.
Downloaded from pubs.acs.org by MCMASTER UNIV on 01/06/19. For personal use only.


## --- Page 2 ---

grown Ni−Fe ﬁlms.23 This work has shown that NiOOH is
present for ﬁlms containing up to ∼50% Fe, and at higher Fe
concentrations there is increasing evidence for a mixture of
FeOOH and Fe2O3. However, neither this work nor other
studies have identiﬁed the local structure of the Fe sites
...
energy resolution ﬂuorescence detection (HERFD) mode. The
...
Ni (see Figure 1). DFT+U calculations reveal the eﬀects of
...
metallic Ni and Fe byproducts that were detected in thicker ﬁlms (see
Supporting Information S2). An intermediate ﬁlm thickness was
...
ﬁlm was subsequently oxidized in 0.1 M KOH by cycling the potential
...
the oxidized ﬁlm (∼10 nm, estimated using the density of the Ni(II)/
Fe(III) layered double hydroxide structure31 at low potential) was
suﬃcient for conventional EXAFS measurements.
...
aligned such that both incident beam and ﬂuorescence would enter
...
detector. In these conventional ﬂuorescence detection measurements
the background from elastic and Compton scattering was reduced
using a combination of Z-1 ﬁlters (3 absorption lengths of Mn (Co)
for Fe (Ni) K-edge spectra) with Soller slits. EXAFS data were
averaged and normalized using SIXPack38 and spline-ﬁtted using
...
for γ-FeOOH42 and γ-NiOOH.43 Least-squares ﬁtting of the Fourier-
transformed EXAFS signals was carried out using IFEFFIT39 through
the SIXPack graphical user interface.38 All EXAFS data were ﬁtted to
...
performed in electrolyte which was carefully puriﬁed to remove any Fe
contamination. Top: a schematic illustrating the inﬂuence of Fe
...
+U).44−46 The RPBE47 parametrization of GGA was chosen together
with rotationally invariant implemetation48 of Hubbard-U term ﬁxed at
...
pseudopotentials50 and plane-wave basis set cutoﬀof 40 and 400 Ry
...
and Fe oxyhydroxide ﬁlms (see Supporting Information S6 for
...
(see Supporting Information S7), pure NiOOH ﬁlms exhibited
...
both below and well within conditions where signiﬁcant OER
...
context of extended X-ray absorption ﬁne structure (EXAFS)
and (iv) spectral ﬁngerprinting using literature data and own
measurements of well-deﬁned reference compounds. The key
...
XAS measurements. The latter can be identiﬁed with the well-
...
lengths9,32,53−56 diﬀer signiﬁcantly between 2.05 Å in Ni(II)-
containing α-Ni(OH)2, and 1.88 Å in γ-NiOOH, which is
nonstoichiometric (NiOOH1−x) and contains a mixture of
Ni(III) and Ni(IV) sites.57 The signiﬁcant shift of both the pre-
...
Fe K-edge. While the potential increase does not inﬂuence the
oxidation-state-sensitive energy of the main absorption threshold
(7125 eV), signiﬁcant Fe−O bond contraction with increasing
...
operando EXAFS measurement conﬁrming the potential-induced
...
ﬁlm). A strong correlation was found not only between Fe−O
...
Figure 3. Identiﬁcation of the most likely structural motif for mixed Ni,Fe catalysts by comparison of experimentally obtained metal−oxygen bond
...
Ni−Ni−Ni arrangements, clearly shows that Fe is not
...
photoionization threshold both shift to signiﬁcantly higher
...
(1.90 ± 0.01) Å at 1.62 V with bond lengths for diﬀerent Fe
...
state from +3 to +4. However, if such a signiﬁcant oxidation
...
and the multiplet structure changes signiﬁcantly from the
...
cannot account for the bond contraction, which clearly aﬀects
...
lengths at diﬀerent potentials can be obtained by applying
either the same relation [(Epeak −E0)d2 = const.] as above, or
linear combination ﬁts using the two spectra of the Ni/Fe
(75:25) sample at 1.12 and 1.92 V as components, which
suﬃciently reproduce all other spectra (Supporting Information
...
diﬀerent Fe3+ species are present, i.e., Fe3+ dopants in α-
...
schematically in Figure 1 (top). The diﬀerent solubility limits
for Fe in Ni(OH)2/NiOOH and Ni in FeOOH could be
attributed to diﬀerences in the capability of the host structures
to compensate the charge diﬀerence between Ni2+ and Fe3+ that
...
protonation of O or OH ligands without a signiﬁcant distortion
...
(“aging”) of α-Ni(OH)2 into β-Ni(OH)2.21
DFT+U calculations were carried out in order to further
understand the eﬀects of Fe substitution into γ-NiOOH and Ni
...
(Supporting Information S3). The DFT+U method oﬀers an
...
optimization; however some deﬁciencies of DFT remain.66 A
...
investigated. This ﬁnding agrees with our experimental
...
is signiﬁcantly higher than for Ni despite the opposite order of
formal oxidation states of both cations. This diﬀerence reﬂects
...
for Ni3+ cations into the lattice of γ-NiOOH. This modiﬁcation
has no eﬀect on the oxidation state of the Ni cations. We
...
FeOOH at Fe contents above 75%. DFT+U calculations
conﬁrm that a Fe−O bond distance similar to that for Ni−O
...
substituted γ-NiOOH diﬀer from those reported earlier.30,32
...
DFT+U calculations rule out the formation of signiﬁcant
...
catalytically inactive γ-FeOOH, with the net eﬀect that the
...
substitute into γ-FeOOH has an eﬀect on the OER activity of
...
potential η obtained from Gibbs free energy diﬀerences ΔGi (i
= 1, ..., 4) at each step as
η =
Δ
Δ
...
fold coordinated metal atoms, and Fe sites have signiﬁcantly
higher OH aﬃnity than Ni sites. While the diﬀerence between
...
condition ΔEO −ΔEOH = 0.5(ΔEOOH −ΔEOH),71 η reaches a
...
structures exhibit decreased aﬃnity for OER intermediates,
...
their higher electron aﬃnity compared to Fe3+, withdraw
...
charged Fe site in Fe-doped γ-NiOOH(011̅2) (Figure 4a). The
...
adsorbed O and OH. We propose that this eﬀect is mostly
...
hematite indicate the same mechanism for the catalytic
enhancement, further supporting our hypothesis.28
Further calculations comparing the overpotentials for the
OER occurring over Ni or Fe sites conﬁrm that Fe rather than
...
already too weak oxygen aﬃnity of Ni further decreases. This
ﬁnding is consistent with the experimentally observed shift of
...
NiOOH phases. While there are substantial diﬀerences in the
...
pure γ-NiOOH. Thus, Li and Selloni ﬁnd that η = 0.48 V for
Fe-doped γ-NiOOH and η = 0.52 V for pure γ-NiOOH,
whereas we ﬁnd that η = 0.43 V for Fe-doped γ-NiOOH and η
...
note that these are interesting ﬁndings, we did not observe any
...
this phase.21
It is signiﬁcant to note that the conclusions regarding the
inﬂuence of Fe on the overpotential for the OER deduced from
the present work diﬀer from those that would have been made
in the absence of this eﬀort. Prior to this study and based on
...
dominant factor aﬀecting the activation barriers for the OER.
...
Fe content. This ﬁnding does not contradict the anodic shift of
...
a strong inﬂuence of the Ni host structure on the local structure
at Fe cations.
...
surface atom in γ-NiOOH(011̅2). The binding energies of these
...
NiOOH(011̅2) and in γ-NiOOH(011̅2) with Fe surface and
subsurface doping, at a Ni on-top site in pure γ-NiOOH(011̅2), and
...
(HOO* in all cases except for the on-top Ni site in γ-NiOOH(011̅2)
and γ-NiOOH(011̅2) with subsurface Fe, where formation of O*
...
much weaker than what is required for an “optimal” catalyst
and therefore cannot account for the signiﬁcant reduction in
...
Ni1−xFexOOH, reﬂecting the substitution of Ni by Fe cations.
...
The conclusions drawn about the eﬀects of Fe on the
...
Fe3+ cations in γ-Ni1−xFexOOH exhibit a signiﬁcantly lower
...
Catalyst preparation, additional EXAFS measurements on
electrodeposited catalyst layers, choice of model (Ni,Fe)OOH
structures for DFT+U, optimized bulk structures and their
density of states, calculation of OER overpotentials, OER
activity measurements, puriﬁcation of KOH electrolyte,
complete set of operando HERFD XAS measurements,
HERFD XAS of Fe and Ni reference compounds, linear
combination ﬁtting of operando HERFD XAS, bond
contraction from HERFD XAS, comparison of structure
information from HERFD XAS and EXAFS. This material is
...
Center for Artiﬁcial Photosynthesis, a DOE Energy Innovation
Hub, supported through the Oﬃce of Science of the U.S.
Department of Energy under Award Number DE-SC0004993.
This research was partly carried out at the Stanford
Synchrotron Radiation Lightsource, a National User Facility
operated by Stanford University on behalf of the U.S.
Department of Energy, Oﬃce of Basic Energy Sciences. We
thank Lena Trotochaud, Harri Ali-Löytti and Lin Li for their
assistance with data collection. We are grateful to Uwe
Bergmann, Thomas Bligaard, Aleksandra Vojvodic and Lena
Trotochaud for helpful discussions. We thank Tyler Matthews
for assistance with sample preparation. M.W.L. was partially
supported by the University of California President’s
Postdoctoral Fellowship. K.E.S. gratefully acknowledges the
Ernest-Solvay-Stiftung for ﬁnancial support. This research
employed NERSC computational resources under DOE
...
Soc. 2012, 134, 16959.
(4) Risch, M.; Grimaud, A.; May, K. J.; Stoerzinger, K. A.; Chen, T. J.;
Mansour, A. N.; Shao-Horn, Y. J. Phys. Chem. C 2013, 117, 8628.
(5) Suntivich, J.; May, K. J.; Gasteiger, H. A.; Goodenough, J. B.;
Shao-Horn, Y. Science 2011, 334, 1383.
(6) Subbaraman, R.; Tripkovic, D.; Chang, K.-C.; Strmcnik, D.;
Paulikas, A. P.; Hirunsit, P.; Chan, M.; Greeley, J.; Stamenkovic, V.;
Markovic, N. M. Nat. Mater. 2012, 11, 550.
(7) McCrory, C. C. L.; Jung, S.; Peters, J. C.; Jaramillo, T. F. J. Am.
Chem. Soc. 2013, 135, 16977.
(8) Kanan, M. W.; Nocera, D. G. Science 2008, 321, 1072.
(9) Bediako, D. K.; Lassalle-Kaiser, B.; Surendranath, Y.; Yano, J.;
Yachandra, V. K.; Nocera, D. G. J. Am. Chem. Soc. 2012, 134, 6801.
(10) Khaselev, O.; Turner, J. A. Science 1998, 280, 425.
(11) Jin, J.; Walczak, K.; Singh, M. R.; Karp, C.; Lewis, N. S.; Xiang,
C. Energy Environ. Sci. 2014, 7, 3371.
(12) Hu, S.; Xiang, C.; Haussener, S.; Berger, A. D.; Lewis, N. S.
Energy Environ. Sci. 2013, 6, 2984.
(13) Gregoire, J. M.; Xiang, C.; Mitrovic, S.; Liu, X.; Marcin, M.;
Cornell, E. W.; Fan, J.; Jin, J. J. Electrochem. Soc. 2013, 160, F337.
(14) Trotochaud, L.; Mills, T. J.; Boettcher, S. W. J. Phys. Chem. Lett.
2013, 4, 931.
(15) Młynarek, G.; Paszkiewicz, M.; Radniecka, A. J. Appl.
Electrochem. 1984, 14, 145.
(16) Corrigan, D. A. J. Electrochem. Soc. 1987, 134, 377.
(17) Miller, E. L.; Rocheleau, R. E. J. Electrochem. Soc. 1997, 144,
3072.
(18) Li, X.; Walsh, F. C.; Pletcher, D. Phys. Chem. Chem. Phys. 2010,
13, 1162.
(19) Landon, J.; Demeter, E.; İnoğlu, N.; Keturakis, C.; Wachs, I. E.;
Vasić, R.; Frenkel, A. I.; Kitchin, J. R. ACS Catal. 2012, 2, 1793.
(20) Trotochaud, L.; Ranney, J. K.; Williams, K. N.; Boettcher, S. W.
J. Am. Chem. Soc. 2012, 134, 17253.
(21) Trotochaud, L.; Young, S. L.; Ranney, J. K.; Boettcher, S. W. J.
...
(24) Smith, R. D. L.; Prévot, M. S.; Fagan, R. D.; Trudel, S.;
Berlinguette, C. P. J. Am. Chem. Soc. 2013, 135, 11580.
(25) Smith, R. D. L.; Prévot, M. S.; Fagan, R. D.; Zhang, Z.; Sedach,
P. A.; Siu, M. K. J.; Trudel, S.; Berlinguette, C. P. Science 2013, 340, 60.
(26) Li, Y.-F.; Selloni, A. ACS Catal. 2014, 1148.
(27) Gao, M.; Sheng, W.; Zhuang, Z.; Fang, Q.; Gu, S.; Jiang, J.; Yan,
Y. J. Am. Chem. Soc. 2014, 136, 7077.
(28) Liao, P.; Keith, J. A.; Carter, E. A. J. Am. Chem. Soc. 2012, 134,
13296.
...
(31) Guerlou-Demourgues, L.; Fournès, L.; Delmas, C. J. Electrochem.
Soc. 1996, 143, 3083.
(32) Balasubramanian, M.; Melendres, C. A.; Mini, S. J. Phys. Chem. B
2000, 104, 4300.
(33) Eisenberger, P.; Platzman, P. M.; Winick, H. Phys. Rev. Lett.
1976, 36, 623.
(34) Hämäläinen, K.; Siddons, D. P.; Hastings, J. B.; Berman, L. E.
...
Casalongue, H. S.; Mbuga, F.; Weng, T.-C.; Nordlund, D.; Sokaras, D.;
Alonso-Mori, R.; Bell, A. T.; Nilsson, A. Phys. Chem. Chem. Phys. 2013,
15, 17460.
(37) Sokaras, D.; Weng, T.-C.; Nordlund, D.; Alonso-Mori, R.;
Velikov, P.; Wenger, D.; Garachtchenko, A.; George, M.; Borzenets,
V.; Johnson, B.; Rabedeau, T.; Bergmann, U. Rev. Sci. Instrum. 2013,
84, 053102.
...
(42) Christensen, H.; Christensen, A. Acta Chem. Scand., Ser. A 1978,
32, 87.
...
(49) Cococcioni, M.; de Gironcoli, S. Phys. Rev. B: Condens. Matter
Mater. Phys. 2005, 71, 035105.
(50) Vanderbilt, D. Phys. Rev. B: Condens. Matter Mater. Phys. 1990,
41, 7892.
(51) Giannozzi, P.; Baroni, S.; Bonini, N.; Calandra, M.; Car, R.;
...
(52) Westre, T. E.; Kennepohl, P.; DeWitt, J. G.; Hedman, B.;
Hodgson, K. O.; Solomon, E. I. J. Am. Chem. Soc. 1997, 119, 6297.
(53) Capehart, T. W.; Corrigan, D. A.; Conell, R. S.; Pandya, K. I.;
Hoffman, R. W. Appl. Phys. Lett. 1991, 58, 865.
(54) Mansour, A. N.; Melendres, C. A. Phys. B 1995, 208−209, 583.
(55) Hu, Y.; Bae, I. T.; Mo, Y.; Scherson, D. A.; Antonio, M. R. Can.
J. Chem. 1997, 75, 1721.
(56) Morishita, M.; Ochiai, S.; Kakeya, T.; Ozaki, T.; Kawabe, Y.;
Watada, M.; Tanase, S.; Sakai, T. Electrochemistry 2008, 76, 802.
(57) Yang, X.; Takada, K.; Itose, M.; Ebina, Y.; Ma, R.; Fukuda, K.;
Sasaki, T. Chem. Mater. 2008, 20, 479.
(58) Bianconi, A.; Garcia, J.; Benfatto, M. In Synchrotron Radiation in
Chemistry and Biology I; Topics in Current Chemistry; Springer:
Berlin, 1988; pp 29−67.
(59) Stöhr, J.; Sette, F.; Johnson, A. L. Phys. Rev. Lett. 1984, 53, 1684.
...
1970, 3, 1033.
(68) Oleś, A.; Szytuła, A.; Wanic, A. Phys. Status Solidi B 1970, 41,
173.
(69) Nørskov, J. K.; Rossmeisl, J.; Logadottir, A.; Lindqvist, L.;
Kitchin, J. R.; Bligaard, T.; Jónsson, H. J. Phys. Chem. B 2004, 108,
17886.
(70) Man, I. C.; Su, H.; Calle-Vallejo, F.; Hansen, H. A.; Martínez, J.
I.; Inoglu, N. G.; Kitchin, J.; Jaramillo, T. F.; Nørskov, J. K.; Rossmeisl,
J. ChemCatChem 2011, 3, 1159.
(71) Koper, M. T. M. J. Electroanal. Chem. 2011, 660, 254.
(72) Bajdich, M.; García-Mota, M.; Vojvodic, A.; Nørskov, J. K.; Bell,
A. T. J. Am. Chem. Soc. 2013, 135, 13521.
Journal of the American Chemical Society
Article
DOI: 10.1021/ja511559d
J. Am. Chem. Soc. 2015, 137, 1305−1313
