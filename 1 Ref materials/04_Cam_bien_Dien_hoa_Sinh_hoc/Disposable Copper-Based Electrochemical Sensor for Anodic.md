...
Xing Pei,†,§ Wenjing Kang,†,§ Wei Yue,‡ Adam Bange,⊥William R. Heineman,‡ and Ian Papautsky*,†
†BioMicroSystems Lab, Department of Electrical Engineering and Computing Systems, University of Cincinnati, Cincinnati, Ohio
45221-0030, United States
‡Department of Chemistry, University of Cincinnati, Cincinnati, Ohio 45221-0172, United States
⊥Department of Chemistry, Xavier University, Cincinnati, Ohio 45207-4221, United States
*
S Supporting Information
ABSTRACT: In this work, we report the ﬁrst copper-based point-
...
care system. Electrochemistry oﬀers a simple approach to metal
detection on the microscale, but traditional carbon, gold (Au), or
platinum (Pt) electrodes are diﬃcult or expensive to micro-
fabricate, preventing widespread use. Our sensor features a new
low-cost electrode material, copper, which oﬀers simple fabrication
...
buﬀer. The sensor was also able to determine zinc in a bovine serum extract, and the results were veriﬁed with independent
...
P
oint-of-care (POC) devices that are accurate, robust, low
...
trained operators. Furthermore, signiﬁcant time delays are
...
necessary to perform these analyses is often signiﬁcant and can
be diﬃcult to obtain in pediatric or severely ill patients.
...
tion,8−10 excess Zn intake can lead to copper deﬁciency and
...
its ionic form. ASV is rapid and can be cost-eﬀective, while
reaching limits of detection (LODs) in the subnanomolar
range. In recent work, we14−16 reported the ﬁrst microscale
...
performed reliably in acetate buﬀer with a LOD of 6 μM for Zn,
...
4893
dx.doi.org/10.1021/ac500277j | Anal. Chem. 2014, 86, 4893−4900
This is an open access article published under an ACS AuthorChoice License, which permits
copying and redistribution of the article or any adaptations for non-commercial purposes.
Downloaded via 113.185.85.238 on May 29, 2026 at 05:27:35 (UTC).
See https://pubs.acs.org/sharingguidelines for options on how to legitimately share published articles.


### Page Images

![Page 1 Image 1](Disposable Copper-Based Electrochemical Sensor for Anodic_images/image-0001-01.png)

![Page 1 Image 2](Disposable Copper-Based Electrochemical Sensor for Anodic_images/image-0001-02.jpeg)
...
conducive to low-cost disposable sensors needed in this POC
application.
Herein, we report a new sensor concept that uses copper
(Cu) ﬁlm as the sensing element. Cu is not a material typically
used as a working electrode in voltammetric analyses because it
is easily oxidized. Nevertheless, it oﬀers a number of advantages
that we cannot overlook. It is a commonly used material in
electronics, is signiﬁcantly lower in cost than gold or platinum,
...
In this work, this limitation is oﬀset by ease of fabrication, in
the context of a disposable sensor application. The electro-
chemical cell is schematically shown in Figure 1b. Our
experimental results show that such a sensor is suﬃciently
stable for at least one electrochemical measurement, which is
more than suﬃcient when disposable POC applications are
...
purchased from Fisher Scientiﬁc, unless stated otherwise.
...
ratio. Sodium acetate buﬀer (0.1 M, pH 4.65) was purchased
from Sigma-Aldrich. Acetate buﬀers with pH from 5 to 6.5 were
prepared by addition of NaOH(s) to the commercial buﬀer.
Solutions containing 0.1 μM to 10 mM Zn were prepared by
diluting Zn stock solution (TraceCERT, 1000 mg/L in 2%
nitric acid, Fluka) with acetate buﬀer (0.1 M, pH 6). Reagents
...
to convert part of the silver ﬁlm to AgCl. The new RE, Cu/
...
with triﬂuoroacetic acid was used to extract Zn from bovine
serum. Dithizone (12.8 mg) was ﬁrst dissolved in 10 mL
chloroform and deprotonated by mixing with 10 mL (pH 9) 1
M ammonia/0.5 M ammonium buﬀer solution to form the
...
triﬂuoroacetic acid for another 5 min. The clear aqueous phase
was collected and mixed with acetate buﬀer (0.1 M). The pH
...
samples. For all the experiments performed in the buﬀer, we
...
![Page 2 Image 1](Disposable Copper-Based Electrochemical Sensor for Anodic_images/image-0002-01.png)
...
repeated our lowest measurable data point, 100 nM of Zn, for
...
electrodeposited and thermally evaporated Bi ﬁlms were
investigated, it is the evaporated Bi WEs that proved to exhibit
more stable (coeﬃcient of variation <2%) measurements of Zn
in acetate buﬀer.16 Although the evaporated Bi WEs performed
well (LOD = 60 nM), the fabrication procedure for these
electrodes was complex and costly, requiring multiple photo-
lithography, e-beam evaporation, and lift-oﬀprocess steps. For
...
based sensors, we developed a sensor based on a Cu thin ﬁlm.
...
simpliﬁed connection and accessibility (Figure 1c). Fabrication
of such a sensor involves a single photolithography step on a
thermally evaporated Cu ﬁlm. This is a signiﬁcant improve-
...
Cu Auxiliary Electrode. It was critical to ﬁrst demonstrate
...
a stable behavior for the ﬁrst 10 min by providing relatively
constant potential below 0.1 V for the oxidation of Cu. The
oxidation and stripping of Cu occurred at a low rate, which had
little eﬀect on the surface of the electrode during this time
(Figure 2a; 0 min). Roughness of a fresh Cu surface was 0.3 ±
0.03 nm. The observed signal variability was quite low
(coeﬃcient of variation = 5%), although the Pt electrode was
clearly superior (coeﬃcient of variation = 0.2%). In the next 10
...
abruptly to a signiﬁcantly more positive value where the AE
...
is kept short. For most stripping analyses, 10 min is suﬃcient
...
10 min with larger current, the Cu AE ﬁlm may be oxidized
...
With more sacriﬁcial Cu for oxidation, the stable ﬂat region can
be extended to over 1 h, depending on ﬁlm thickness (Figure
...
with zoom-in optical proﬁler images illustrating surface roughness
...
![Page 3 Image 1](Disposable Copper-Based Electrochemical Sensor for Anodic_images/image-0003-01.png)
...
applications with more acidic electrolyte or longer preconcen-
...
suﬃcient for rapid analysis, we next examined the electro-
...
acetate buﬀer (0.1 M, pH 6) spiked with 10 mM Zn to indicate
...
CuCl2 RE. The 60 mV diﬀerence in peak potential due to
diﬀerences in RE half-cell potentials is not signiﬁcant. Overall,
...
Ag/AgCl RE in acetate buﬀer (0.1 M, pH 6). To simulate the
working environment of our integrated REs in the buﬀer, no
...
examined directly. The potential diﬀerence between the
integrated Cu/CuCl2 and the commercial Ag/AgCl REs was
−59 ± 3 mV, while the diﬀerence between the integrated and
commercial Ag/AgCl RE was −36 ± 6 mV (Figure 4a). The
Cu/CuCl2 RE exhibited a short ∼28 s response time in
stabilizing the potential diﬀerence, which was faster than the 46
s observed for the Ag/AgCl RE. This diﬀerence in the response
time may be due to diﬀerences in solubility of CuCl2 and AgCl,
...
buﬀer makes the integrated Cu/CuCl2 RE an attractive option
...
buﬀer (0.1 M, pH 6) with preconcentration times ranging from
...
actually aﬀect our application since we are measuring the
...
aﬀect Zn stripping. Having established that Cu-based auxiliary
Figure 3. Cyclic voltammetry performed with Cu/CuCl2 (solid) or
Ag/AgCl (dashed) as RE, in acetate buﬀer (0.1 M, pH 6) with 10 mM
Zn. Scan rate = 100 mV/s.
Figure 4. Stability of Cu/CuCl2 reference electrode. (a) Potential of
integrated Cu/CuCl2 and Ag/AgCl electrodes in acetate buﬀer (0.1 M,
pH 6) vs commercial (double junction) Ag/AgCl electrode. Each
curve is an average of n = 3. (b) ASV of 10 μM Zn in the acetate buﬀer
...
![Page 4 Image 1](Disposable Copper-Based Electrochemical Sensor for Anodic_images/image-0004-01.png)

![Page 4 Image 2](Disposable Copper-Based Electrochemical Sensor for Anodic_images/image-0004-02.png)
...
and reference electrodes are possible, we focused on
...
its potential window is not known. As the ﬁrst step in
...
shows the results for CV in the acetate buﬀer (0.1 M, pH 4.65),
...
more positive than the stripping potential of Bi. The signiﬁcant
...
suﬃciently wide for determination of Zn, oﬀering a 130−190
...
the potential limit of the Cu ﬁlm is suﬃciently negative to make
...
potential window shows, the Cu WE oﬀers a suﬃciently
...
Cu-based sensor, we investigated the eﬀect of buﬀer pH on the
potential window of the Cu electrode. CV analysis was
performed in 0.1 M acetate buﬀers with pHs in the 4.65−6.5
...
6.5. For acetate buﬀer with pH < 4.65, water electrolysis begins
at a more positive potential than the Zn stripping peak. For
buﬀer with pH > 6.5, Zn2+ forms hydroxides,30 which aﬀects the
...
variability. Thus, for anodic stripping voltammetry, buﬀer with a
...
suﬃciently negative to permit determination of trace metals
such as Zn, Cd, or Pb.
ASV in Acetate Buﬀer. Following optimization of
experimental and stripping waveform parameters (see the
Supporting Information), a calibration curve was constructed
by performing ASV in 100 μL of acetate buﬀer (0.1 M, pH 6)
...
Figure 5. (a) Cyclic voltammetry of diﬀerent WE materials in the
acetate buﬀer (0.1 M, pH 4.65) with commercial Ag/AgCl (double
junction) RE and Pt AE. Scan rate = 100 mV/s. Inset illustrates
threshold potentials (i = 10 μA) of diﬀerent WE materials (n = 3). (b)
Cyclic voltammetry of Cu-based sensor in the acetate buﬀer (0.1 M) at
diﬀerent pH. Scan rate was 100 mV/s. (c) The threshold potential (i =
4 μA) at diﬀerent pH (n = 3).
Analytical Chemistry
Article
dx.doi.org/10.1021/ac500277j | Anal. Chem. 2014, 86, 4893−4900
4897
...
![Page 5 Image 1](Disposable Copper-Based Electrochemical Sensor for Anodic_images/image-0005-01.png)
...
calculated LOD of the Cu-based sensor for Zn determination is
...
as that in the buﬀer, as we discuss below. For the Cu-based
...
diﬀerence in stripping potential for Zn that has been deposited
...
complete. Thus, Zn will be stripped from diﬀerent surfaces at
diﬀerent potentials, resulting in broadened or doubled stripping
peaks. Speciﬁcally for voltammograms in the 20−40 μM range,
...
free metal ions,34 which requires Zn to be ﬁrst released from
...
higher binding aﬃnity between Zn and protein.36 While the
commonly used method of acidiﬁcation by HCl to digest serum
...
procedure with dithizone and triﬂuoroacetic acid that was
...
extracted serum diluted 2× with acetate buﬀer (0.1 M, pH 6),
and samples spiked with additional 1 and 5 μM of Zn (Figure
7a) (n = 3). We used the same stripping parameters as in the
buﬀer, except for double volume of 200 μL and preconcentra-
...
buﬀer (0.1 M, pH 6, 100 μL sample volume).
...
![Page 6 Image 1](Disposable Copper-Based Electrochemical Sensor for Anodic_images/image-0006-01.png)

![Page 6 Image 2](Disposable Copper-Based Electrochemical Sensor for Anodic_images/image-0006-02.png)
...
RE, the several orders of magnitude diﬀerences in the chloride
concentration between acetate buﬀer with no chloride added
...
at approximately the same position as in the buﬀer while
...
more soluble than AgCl, with a ∼105 diﬀerence in their
solubility.
...
buﬀer. Considering the larger deviation of potentials and
...
buﬀer, which is attributed to a signiﬁcantly higher complexity of
...
sensors.
■CONCLUSIONS
We developed the ﬁrst Cu-based sensor for ASV and
demonstrated the detection of Zn in buﬀer and extracted
...
sensors are qualiﬁed to be the low-cost disposable sensors for
POC instruments. Second, the microfabrication procedure of
the Cu-based sensor is quite simple. Microfabrication oﬀers the
...
disposable applications. Third, Cu-based sensors oﬀer com-
...
processing system that would be integrated by microﬂuidics
...
Discussion of stability of Cu/CuCl2 RE and the optimization of
the experimental parameters (buﬀer pH, preconcentration
potential, and time) and stripping waveform parameters to
improve sensor performance (maximize stripping peak current
and peak sharpness). This material is available free of charge via
the Internet at http://pubs.acs.org.
■AUTHOR INFORMATION
Corresponding Author
*Address: Department of Electrical Engineering and Comput-
ing Systems, 812 Rhodes Hall, ML030, University of
Cincinnati, Cincinnati, OH 45221, United States. Tel: (513)
556-2347. Fax: (513) 556-7326. E-mail: ian.papautsky@uc.edu.
...
Institutes of Health (NIH) awards R21ES019255 and
R01ES022933.
■REFERENCES
(1) Smith, J.; Butrimovitz, G.; Purdy, W. Clin. Chem. 1979, 25,
1487−1491.
(2) Jenner, G.; Longerich, H.; Jackson, S.; Fryer, B. Chem. Geol. 1990,
83, 133−148.
(3) Vallee, B. L.; Falchuk, K. H. Physiol. Rev. 1993, 73, 79−118.
(4) Tapiero, H.; Tew, K. D. Biomed. Pharmacother. 2003, 57, 399−
411.
(5) Wong, H. R.; Cvijanovich, N.; Allen, G. L.; Lin, R.; Anas, N.;
Meyer, K.; Freishtat, R. J.; Monaco, M.; Odoms, K.; Sakthivel, B. Crit.
Care Med. 2009, 37, 1558.
