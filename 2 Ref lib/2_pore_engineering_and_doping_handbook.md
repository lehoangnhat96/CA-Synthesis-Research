...
| Tiền chất (Biomass) | Tác nhân biến tính / Doping | Nhiệt độ nung (°C) | Diện tích bề mặt BET ($m^2/g$) | Đặc điểm cấu trúc / Liên kết nổi bật | Ảnh hưởng thực nghiệm |
| :--- | :--- | :---: | :---: | :--- | :--- |
| **Xơ dừa (Coir)** | NH₄OH / Urea (One-pot N source) | **600** | **2510** | Chủ yếu hình thành **Pyrrolic-N** dồi dào, giữ lượng N tốt (4–6 wt.%), cấu trúc tổ ong. | **Mẫu khuyến nghị cho biosensor** (Cân bằng tốt nhất giữa độ dẫn và hoạt tính giả tụ). |
| **Xơ dừa (Coir)** | NH₄OH / Urea (One-pot N source) | **700** | **3603** | **Pyridinic-N** chiếm ưu thế tuyệt đối (Cấu trúc khuyết tật cao), diện tích bề mặt lớn nhất. | **Tối ưu cho phản ứng khử oxy (ORR)** trong pin Mg-air hoặc pin nhiên liệu. |
...
Bảng đối chứng hiệu suất lưu trữ năng lượng và điện hóa của các dòng carbon sinh khối hỗ trợ bảo vệ tính mới của đề tài:
...
1.  **Cơ chế đúc băng (Ice-Templating):**
    *   Khi đông lạnh dung dịch cellulose xơ dừa ở $-80^\circ\text{C}$, các tinh thể đá rỗng phát triển theo định hướng trục nhiệt độ, đẩy các chuỗi cellulose dồn lại sát nhau.
