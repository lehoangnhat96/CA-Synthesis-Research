...
```mermaid
graph TD
    Root[Thư mục Gốc: pdf-to-md-conversion] --> D01[01_Tien_xu_ly_Nguyen_lieu: 17 tệp]
    Root --> D02[02_Doping_va_Gel_hoa: 34 tệp]
    Root --> D03[03_Say_va_Nung_Nhiet_phan: 3 tệp]
    Root --> D04[04_Cam_bien_Dien_hoa_Sinh_hoc: 35 tệp]
    Root --> D05[05_Cross_Linker_va_Tao_mang: 20 tệp]
    Root --> D06[06_Setup_Do_Dien_hoa: 7 tệp]
    Root --> D07[07_Giao_trinh_Ly_thuyet: 3 tệp]
    Root --> D08[08_Review_va_Tong_quan: 8 tệp]
    Root --> D09[09_Tai_lieu_Quy_trinh_AI: 16 tệp]
    Root --> D_Dup[Duplicates_Backup: Backup file trùng lặp]
```
