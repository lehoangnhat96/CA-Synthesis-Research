...
| Ramp 3 | 400°C → T_target | 5°C/min | 2h |
...
```markdown
m_FeCl3.6H2O = m_sample * w_Fe * (270.3 / 55.845)
```
...
| Binder 1 | Chitosan 1% trong acid acetic 1% (tham chiếu: A screen-printed carbon electrode modified with a chitosan-based film for in situ heavy metal ions measurement, thư mục 05_Cross_Linker_va_Tao_mang, hướng chất liên kết chitosan đo kim loại nặng bằng SWASV) |
| Binder 2 | Nafion 5 wt% thương mại (pha chế đạt đúng 0.25 wt% hoạt tính cao, tham chiếu: Facile Synthesis of Fe-Doped, Algae Residue-Derived Carbon Aerogels for Electrochemical Dopamine Biosensors, thư mục 02_Doping_va_Gel_hoa, hướng chất liên kết Nafion đo paracetamol/dopamine bằng DPV) |
...
| XPS Fe 2p | Fe²⁺/Fe³⁺, Fe–Nₓ (phức phối trí đơn nguyên tử dạng Fe–N₄) | Có tín hiệu Fe–Nₓ |
...
| Thế lắng khử E_dep | –0.8 đến –1.4 V vs Ag/AgCl |
| Thế lắng khử khởi đầu cho riêng Pb²⁺/Cd²⁺ | –1.1 V |
| Thế lắng khử khởi đầu cho Zn²⁺ (đo đồng thời) | –1.3 V đến –1.4 V |
| Thời gian lắng khử t_dep | 60–240 s |
| Giá trị lắng khử khởi đầu t_dep | 120 s (tham chiếu: A screen-printed carbon electrode modified with a chitosan-based film for in situ heavy metal ions measurement, thư mục 05_Cross_Linker_va_Tao_mang, hướng đo kim loại nặng bằng SWASV) |
...
|---|---|---|
| LOD | 3σ/slope | (tham chiếu lý thuyết đo: ANALYTICAL_ELECTROCHEMISTRY_SECOND_EDITION, thư mục 07_Giao_trinh_Ly_thuyet, hướng tính giới hạn phát hiện) Pb²⁺ < 0.1 µg/L; paracetamol < 0.1 µM |
| LOQ | 10σ/slope | Báo cáo theo đường chuẩn |
| Sensitivity | Slope / ECSA | So sánh literature |
